...
- לכל שאילתא על מבט: תיאור מילולי, קוד השאילתא, ופלט מבוסס התמונות
...
7. קובץ גיבוי מעודכן בשם `backup3` (לא נמצא בתיקיה זו בשלב זה)
8. קובץ המשך דוח הפרויקט שלב ג' (לא נמצא בתיקיה זו בשלב זה)

> שים לב: הקבצים `backup3` ו-`דוח הפרויקט שלב ג'` לא היו זמינים בתיקיית `ex3` כאשר נבנה דוח זה. אם קיימים במיקום אחר, יש להוסיף אותם לדוח.
...
> התמונות לעיל מציגות את המבנים הלוגיים והיחסים בין ישויות המערכת לאחר אינטגרציה.
...
![שאילתות trip_full_details_view](screenshots/Screenshot 2026-06-01 105612.png)

> בתמונה זו מופיעה שאילתת הסיכום לפי נהג ופלט התוצאה של `trip_full_details_view`.
...
![שאילתות active_trip_details](screenshots/Screenshot 2026-06-01 111237.png)

> בתמונה זו מופיע פלט ספירת הנסיעות הפעילות לפי נהג מתוך המבט `public.active_trip_details`.
